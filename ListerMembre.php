    ...
    <h2><u>Liste des Abonnées</u></h2>
        <table class="table table-sm">
            ...
            foreach ($membres as $membre){
                    ...
                    echo "<td><a class='btn btn-warning' href='suppMembre.php?ID_Membre=" . $membre['ID_Membre'] . "'>Supprimer</a>  <a class='bbb btn btn-success' href='modifiermembre.php?ID_Membre=" . $membre['ID_Membre'] . "'>Modifier</a></td>";
                    echo "</tr>";
}
                ?>
