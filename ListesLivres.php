...
$livres = $stmt->fetchAll(PDO::FETCH_ASSOC);
    ...
    echo "<td><a class='btn btn-warning' href='suppLivre.php?ID_Livre=" . $livre['ID_Livre'] . "' onclick='return confirm(\"Êtes-vous sûr de vouloir supprimer ce livre ?\");'>Supprimer</a>  <a class='bbb btn btn-success' href='modifierpage.php?ID_Livre=" . $livre['ID_Livre'] . "'>Modifier</a></td>";
