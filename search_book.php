...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Get other user input (isbn, nom, auteur, etc.)
    ...
    // Check which fields are filled and create the corresponding SQL conditions
    // ...

    // If a genre is selected, add it as a condition
    ...
    // Create the SQL query to search for the book based on the user input
